...
from memory import update_memory_if_required
...
def main():
    ...
    update_memory_if_required(memory_model, memory_prompt, memory_maxmsgs, memory, server_url, context_file_path, load_context)
